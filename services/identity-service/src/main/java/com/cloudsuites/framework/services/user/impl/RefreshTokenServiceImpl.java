package com.cloudsuites.framework.services.user.impl;
...
public class RefreshTokenServiceImpl implements RefreshTokenService {
    ...
    public UserSession rotateRefreshToken(String currentRefreshToken, String newRefreshToken, String accessTokenJti) {
        ...
        Optional<UserSession> sessionOpt = userSessionRepository.findByRefreshTokenHashAndActive(currentTokenHash);
    ...
    public Optional<UserSession> validateRefreshToken(String refreshToken) {
        ...
        Optional<UserSession> sessionOpt = userSessionRepository.findByRefreshTokenHashAndActive(tokenHash);
        if (sessionOpt.isEmpty()) {
