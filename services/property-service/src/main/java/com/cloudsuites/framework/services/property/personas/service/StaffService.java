...
public interface StaffService {
    ...
    @Transactional
    Staff createStaff(Staff staff, String companyId, String buildingId) throws NotFoundResponseException, UserAlreadyExistsException, InvalidOperationException;
