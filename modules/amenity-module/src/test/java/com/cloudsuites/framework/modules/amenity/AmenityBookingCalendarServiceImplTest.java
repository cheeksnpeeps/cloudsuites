...
class AmenityBookingCalendarServiceImplTest {
    ...
    void testGetBookingsForUser() {
        ...
        when(bookingRepository.findByUserIdAndFilters(userId, null, AmenityType.BARBECUE_AREA, startDate, endDate)).thenReturn(List.of(booking));
        // Act
        ...
        verify(bookingRepository, Mockito.times(1)).findByUserIdAndFilters(userId, null, AmenityType.BARBECUE_AREA, startDate, endDate);
    }
