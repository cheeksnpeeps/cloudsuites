...
@Tags(value = {@Tag(name = "AmenityBookingCalendar", description = "Operations related to Tenants amenity booking calendar")})
public class TenantBookingCalendarRestController {

    private static final Logger logger = LoggerFactory.getLogger(TenantBookingCalendarRestController.class);
    private final AmenityBookingCalendarService amenityBookingCalendarService;
    private final AmenityBookingMapper mapper;

    @Autowired
    public TenantBookingCalendarRestController(AmenityBookingCalendarService amenityBookingCalendarService, AmenityBookingMapper mapper) {
    ...
    public ResponseEntity<AmenityBookingCalendarDto> getTenantBookingCalendar(
        ...
        logger.debug("Getting booking calendar for tenant: {} between {} and {}", tenantId, startTime, endTime);
        ...
        return getBookingCalendar(tenantId, null, startTime, endTime, bookedSlotsDtos);
    }
    ...
    public ResponseEntity<AmenityBookingCalendarDto> getBookingCalendarByAmenity(
        ...
        List<AmenityBookingDto> bookedSlotsDtos = mapper.convertToDTOList(bookedSlots);
        return getBookingCalendar(null, amenityId, startTime, endTime, bookedSlotsDtos);
    }

    private ResponseEntity<AmenityBookingCalendarDto> getBookingCalendar(String tenantId, String amenityId, LocalDateTime startTime, LocalDateTime endTime, List<AmenityBookingDto> bookedSlots) {
