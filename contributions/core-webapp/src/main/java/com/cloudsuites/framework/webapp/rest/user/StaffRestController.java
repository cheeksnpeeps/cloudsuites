...
public class StaffRestController {
    ...
    @PreAuthorize("hasAuthority('ALL_ADMIN') or hasAuthority('BUILDING_SUPERVISOR') or hasAuthority('BUILDING_SECURITY')")
    ...
    @PreAuthorize("hasAuthority('ALL_ADMIN') or hasAuthority('BUILDING_SUPERVISOR') or hasAuthority('SUPER_ADMIN')")
