...
public class StaffRestController {
    ...
    @Autowired
    public StaffRestController(StaffService staffService, StaffMapper mapper, UnitService unitService, UserService userService, @Qualifier("managementCompanyService") ManagementCompanyService managementCompanyService, BuildingService buildingService) {
    ...
    @PostMapping("/company/{companyId}/building/{buildingId}/staff")
    @JsonView(Views.StaffView.class)
    ...
    @ApiResponse(responseCode = "201", description = "Staff created successfully", content = @Content(mediaType = "application/json"))
    @ApiResponse(responseCode = "400", description = "Bad Request")
    @PostMapping("/company/{companyId}/staff")
    @JsonView(Views.StaffView.class)
